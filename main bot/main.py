...
def user_help(update: Update, context: CallbackContext) -> None:
    update.message.reply_text(
        "ℹ️ *To use this bot, just send a URL or use /site command followed by the URL and I will extract the site details for you.*\n\n"
...
def button_handler(update: Update, context: CallbackContext) -> None:
    ...
    if query.data == "admin_commands":
        ...
        query.message.reply_text("Tools:\n\n"
                                  "1. Site Details Extractor\n"
                                  "Send a URL and the bot will extract the site details for you.")   
